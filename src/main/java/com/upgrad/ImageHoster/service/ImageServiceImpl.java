...
public class ImageServiceImpl implements ImageService {
    ...
    @Override
    public Image getByTitle(int id) {
       return imageManager.getImageByTitle(id);
    }

    @Override
    public Image getByTitleWithJoin(int id) { return imageManager.getImageByTitleWithJoins(id); }
