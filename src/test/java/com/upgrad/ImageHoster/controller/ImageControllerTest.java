...
public class ImageControllerTest {
    ...
    public void shouldRenderRequestedImage() throws Exception {
        ...
        // setup the mock imageService to return the mock image as a List<Image>;
        Mockito.when(imageService.getByTitleWithJoin(Mockito.anyInt())).thenReturn(image);
    ...
    public void shouldDeleteImageOk() throws Exception {
        ...
        Mockito.when(imageService.getByTitle(Mockito.anyInt())).thenReturn(new Image());
    ...
    public void shouldEditImageOk() throws Exception {
        ...
        Mockito.when(imageService.getByTitleWithJoin(Mockito.anyInt())).thenReturn(new Image());
